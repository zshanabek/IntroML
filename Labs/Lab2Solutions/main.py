...
train_final_features = lab2.extract_final_features(train_texts, dictionary, bigram_dictionary)
val_final_features = lab2.extract_final_features(val_texts, dictionary, bigram_dictionary)
test_final_features = lab2.extract_final_features(test_texts, dictionary, bigram_dictionary)
